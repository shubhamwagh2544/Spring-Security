...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    //howJWT : attemptAuthentication
    //Step 1 : Client sends credentials and credentials validation at Server
    @Override
    ...
    //howJWT : successfulAuthentication
    //Step 2 : Server sends JWT token after client credentials validation
    @Override
